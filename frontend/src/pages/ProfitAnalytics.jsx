  ...
  return (
    <div className="flex h-screen bg-[#f8f9fa] font-sans">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4" data-option-group>
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              <select value={filter} onChange={e => setFilter(e.target.value)} data-default-focus className="text-xs p-1.5 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                <option value="today">Today</option>
                <option value="this_month">This Month</option>
                <option value="this_year">This Year</option>
                <option value="all">All Time</option>
              </select>
              <button onClick={fetchAnalytics} disabled={loading} data-option className="bg-[#1b4985] text-white px-3 py-1.5 text-xs font-bold rounded flex items-center gap-1 hover:bg-blue-800 disabled:opacity-50">
