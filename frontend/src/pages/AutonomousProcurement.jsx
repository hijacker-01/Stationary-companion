      ...
      <main className="flex-1 p-2 overflow-auto">
        ...
        <div className="flex gap-1 mb-2 bg-white border border-gray-300 p-1">
          {[["scores","Supplier Scores"],["rfqs","Active RFQs"],["auto","AI Draft POs"]].map(([k,l]) => (
            <button key={k} onClick={() => setTab(k)} className={`px-3 py-1 text-xs font-bold rounded ${tab === k ? "bg-[#1b4985] text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}>{l}</button>
          ))}
        </div>
        {tab === "scores" && (
          <div className="bg-white border border-gray-300 shadow-sm">
            <div className="bg-[#1b4985] text-white p-2 font-bold flex items-center"><Award className="w-4 h-4 mr-2"/> Supplier Performance Rankings</div>
        ...
        {tab === "rfqs" && (
          <div className="bg-white border border-gray-300 shadow-sm">
            <div className="bg-[#1b4985] text-white p-2 font-bold flex items-center justify-between"><span className="flex items-center"><ShoppingCart className="w-4 h-4 mr-2"/> Active RFQs</span><button onClick={() => setShowModal(true)} className="bg-[#1b4985] text-white px-3 py-1 rounded text-xs hover:bg-[#163a6b]">+ New RFQ</button></div>
        ...
        {tab === "auto" && (
          <div className="bg-white border border-gray-300 shadow-sm">
            <div className="bg-[#1b4985] text-white p-2 font-bold flex items-center"><Zap className="w-4 h-4 mr-2"/> AI-Generated Draft Purchase Orders</div>
