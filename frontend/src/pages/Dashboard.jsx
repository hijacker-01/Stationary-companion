...
export default function Dashboard() {
  ...
  const rightActions = [
    ...
    { label: "PUR/DM (Direct Purchase)", to: "/purchase-bills", ai: false },
    { label: "AI Smart Ledger / Scan", to: "/ai-ledger", ai: true },
    { label: "Receipt", to: "/vouchers", ai: false },
    { label: "Payment", to: "/vouchers", ai: false },
    { label: "Cash & Bank Book", to: "/ledger", ai: false },
    { label: "Ledger A/c", to: "/ledger", ai: false },
    { label: "Outstanding", to: "/customers", ai: false },
    { label: "Stock Status", to: "/inventory", ai: false },
    { label: "Stock & Sales Analysis", to: "/reports", ai: false },
    { label: "AI Re-Order Agent", to: "/reorder-center", ai: true },
    { label: "Sales Book", to: "/reports", ai: false },
    { label: "AI Expiry Guard", to: "/expiry-guard", ai: true },
    { label: "Bill Taging", to: "/billing", ai: false },
    { label: "Daily Analysis (MIS)", to: "/reports", ai: false },
