...
export default function Customers() {
  ...
  return (
    ...
    >
        ...
        {showModal && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onKeyDown={(e) => { if (e.key === 'Enter' && e.shiftKey && form.name?.trim()) handleSave(); }}>
            <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-6 border border-slate-100 animate-in fade-in zoom-in-95 duration-150">
              ...
              <div className="flex flex-col gap-2 mt-6">
                <button onClick={handleSave} disabled={!form.name?.trim()} tabIndex={-1}
