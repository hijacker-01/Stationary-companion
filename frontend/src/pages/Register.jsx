    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center relative overflow-hidden selection:bg-brand-200">
      ...
      <div className="w-full max-w-4xl mx-4 z-10">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[550px]">
          ...
          {/* Brand Panel */}
          <div className="md:w-5/12 bg-gradient-to-br from-brand-700 to-indigo-900 text-white p-10 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-10 h-10 bg-white text-brand-700 rounded-xl flex items-center justify-center font-bold text-xl shadow">M</div>
              ...
              <p className="text-brand-100 text-sm font-light leading-relaxed">
            ...
            <div className="relative z-10 space-y-4 my-8">
              {[
                ...
                <div key={item.s} className="flex items-center gap-3">
                  ...
                  <div>
                    <p className={`text-xs font-bold leading-none ${step === item.s ? "text-white" : "text-brand-200/70"}`}>{item.title}</p>
                    <p className="text-[10px] text-brand-200/50 mt-0.5">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="md:w-7/12 p-8 lg:p-12 flex flex-col justify-center bg-white">
            <div className="w-full max-w-md mx-auto">
              <div className="mb-6">
                <span className="text-[10px] uppercase tracking-wider text-brand-600 font-bold">Step {step} of 3</span>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 font-mono"
                        />
                      </div>
                      <div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  {step < 3 ? (
                    <button
                      type="button"
                      onClick={handleNext}
                      className="flex-1 bg-brand-600 hover:bg-brand-700 text-white py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition shadow-lg shadow-brand-500/20"
                    >
              ...
              <div className="mt-6 text-center">
                <p className="text-xs text-gray-500">
                  ...
                  <button onClick={() => navigate("/")} className="text-brand-600 hover:underline font-bold">Sign In</button>
                </p>
              </div>
            </div>
          </div>
